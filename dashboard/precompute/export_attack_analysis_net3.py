...
Run once before launching the dashboard:
    python dashboard/precompute/export_attack_analysis_net3.py
"""
...
def main():
    ...
    # Load data
    data_dir = PROJECT_ROOT / "data" / "temporal_moe_net3"
    ...
    norm_path = PROJECT_ROOT / "runs" / "multitask" / "20260505_163339" / "normalizer.pt"
    ...
    state = torch.load(
        PROJECT_ROOT / "runs" / "multitask" / "20260505_163339" / "best_model.pt",
    ...
    # Save
    out_path = PROJECT_ROOT / "dashboard" / "data" / "attack_analysis_net3.json"
