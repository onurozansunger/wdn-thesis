"""Pre-compute Net3 demo data for the dashboard.

Run once:
    python dashboard/precompute/export_net3_demo.py
"""
...
def main():
    ...
    run_dir = PROJECT_ROOT / "runs" / "multitask" / NET3_RUN
    ...
    out_path = PROJECT_ROOT / "dashboard" / "data" / "net3_demo.json"
    ...
    print(f"\nSaved Net3 demo data to {out_path}")
